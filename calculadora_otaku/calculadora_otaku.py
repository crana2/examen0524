# HAZ UNA CALCULADORA QUE TENGA UN BOTON PARA CADA NUMERO DEL 0 AL 9, UN BOTON PARA CADA OPERACION
# UN BOTON PARA LOS PARENTESIS, UN BOTON PARA LA COMA DECIMAL, UN BOTON PARA EL IGUAL,
# SOLO UNA CAJA DE TEXTO

# luego tenemos ttk PERO ESTA UN POCO MAS ORIENTADO A DISEÑO
...
def uncion(event):
    if event.char = "+"
        print("Has pulsado esto")


ventana.bind("<key>, uncion")


EVAL TRADUCE UNA CADENA A UNA OPERACION DIRECTAMENTE
resultado = eval(f"{num1} {operacion} {num2}")

ESto es para pasarle parametros a la funcion , cuando la funcion tiene parametros
